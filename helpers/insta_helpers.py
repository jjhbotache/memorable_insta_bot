...
def get_data_from_insta_user(username):
  ...
  user_info_to_return["stared_stories"] =[s.text for s in driver.find_elements("xpath",'/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[2]/div/div[2]/section/main/div/div[1]/div/div/div[1]/div/ul/li')]
  ...
  user_info_to_return["profile_picture"] = user_info_to_return["imgs"][0]
